...
class DBHelper {
    ...
    static registerServiceWorker() {
        ...
        window.addEventListener('load', function() {
            ...
            // navigator.serviceWorker.register('/software.js', {
            //     scope: '/'
            navigator.serviceWorker.register('/restaurant-reviews-app-stage-1/software.js', {
    ...
    static get DATABASE_URL() {
        ...
        return `https://josaphinejoe.github.io/restaurant-review-web-app/data/restaurants.json`;
    }
